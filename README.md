...
| Prefix | Description |
| :-: | :-: |
| about undefined | Give the BOT a little description of itself. They deserve some too. |
| help [Command] | Displays all of the commands available. If a command is specified, it will display the description of the command. That's this command |
| stats undefined | Shows the status of the bot. |
| uptime undefined | Shows the uptime of the bot |
| role <Options> <...arguments> | Advanced role command, additional arguments will change how it react. |
| roles undefined | Gives a list of the roles and a little description of what they do |
| ping undefined | Pings the Bot, and it will reply with a message containing the Ping of the bot. |
